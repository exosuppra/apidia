  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 left-6 h-14 w-14 rounded-full shadow-lg z-50 overflow-hidden border-2 border-primary/30 hover:border-primary transition-colors hover:scale-105 active:scale-95"
        title="Contacter OTO"
      >
        <img
          src={otoAvatar}
